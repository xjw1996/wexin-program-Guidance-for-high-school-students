...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({
     ...
     wx.setStorageSync('politic', {"zhengzhi":3});
     wx.setStorageSync('zhengzhi_result', [{"final_result":final_result},{"final_score":final_score},{"interest_result":interest_result},{"interest_score":interest_score},{"wrong_list":this.data.lishui_score[7].wrong_list}]);
     this.setData({
