...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({
     ...
     wx.setStorageSync('biology', {"shengwu":4});
     wx.setStorageSync('shengwu_result', [{"final_result":final_result},{"final_score":final_score},{"interest_result":interest_result},{"interest_score":interest_score},{"wrong_list":this.data.lishui_score[7].wrong_list}]);
     this.setData({
  ...
  onShow: function () {
    ...
    new wxCharts({
      ...
      series: [{
        name: '大于24 对历生物学科非常感兴趣',
        data: 12,
        stroke: false
      },{
        name: '18与24之间 对生物学科比较感兴趣',
        data: 6,
        stroke: false
      }, {
        name: '12与18之间 对生物学科兴趣一般',
        data: 6,
        stroke: false
      }, {
        name: '7.5与12之间 对生物学科不太感兴趣',
        data: 6,
        stroke: false
      },{
        name: '小于7.5 对生物学科很不感兴趣',
        data: 7.5,
        stroke: false
      },],
      disablePieStroke: true,
