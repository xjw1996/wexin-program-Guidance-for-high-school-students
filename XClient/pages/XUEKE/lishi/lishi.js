...
var e_score=0;
var l_score=0;
var A=[5,7,16,23,26,29,33,35,43,46,47];
var B=[13,17,19,30,45];
var C=[3,6,9,12,15,22,25,36,37,40,42,49];
var D=[0,2,10,20,27,32,39];
...
Page({
  ...
  if_A:function(){
    ...
    if (n > 49) {
      wx.redirectTo({
        url: '../lishi_result/lishi_result?info='+info
      })
