...
var e_score=0;
var l_score=0;
var A=[6,13,16,17,20,27,29,32,33,36,37,45,49];
var B=[5,15,22,23,25,26,30,42];
var C=[0,9,12,35,39,40,43,47];
var D=[2,3,7,10,19,46];
...
Page({
  ...
  if_A:function(){
    ...
    if (n > 49) {
      wx.redirectTo({
        url: '../zhengzhi_result/zhengzhi_result?info='+info
      })
